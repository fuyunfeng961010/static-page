...
function checkemail(){
	var newemail=myemail.value;
	var reg=/^[\w-]+@[0-9a-zA-Z]+(\.[a-z]+){1,3}$/;
	var email=newemail.match(reg)
	return checkall(email,p3);
}
function checktel(){
